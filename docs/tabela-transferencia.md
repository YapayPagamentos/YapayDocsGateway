...
parcelas|	Quantidade de parcelas da transação. Transferencia apenas á vista|	Numérico|	Até 2 dígitos|	Não
...
urlPagamento|	URL de redirecionamento para  Transferência |	Alfa Numérico|	Até 500 caracteres
